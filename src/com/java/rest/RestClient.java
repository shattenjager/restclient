...
public class RestClient {
	public static void main (String args[]) {
		public getLargestCityAndCapital(String state) throws Exception {

	        RestTemplate restTemplate = new RestTemplate();
	        JsonObject apiResponse = new JsonParser().parse(
	                restTemplate.getForEntity("http://services.groupkt.com/state/get/USA/all", String.class).getBody()).getAsJsonObject();
